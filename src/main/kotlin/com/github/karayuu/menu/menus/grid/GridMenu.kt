...
import com.github.karayuu.player.property.GridRegion.DirectionType
import com.github.karayuu.util.*
...
object GridMenu : Menu() {
    ...
    override val openSound: Triple<Sound, Float, Float>
        get() = Triple(Sound.BLOCK_STONE_BUTTON_CLICK_ON, 1F, 1F)
